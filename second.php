...
<div class="container">
  ...
  <div class="row">
      <div class="col-lg-3"><br/><br/><br/><br/><br/><br/><br/><br/><br/>
	   ...
	   <div class="col-lg-7">
	      <h1 style="font-family:garamond;color:#05386B" class="text-center">Legal firms</h1>
		  <h4 class="text-center" style="font-family:serif;color:#5CDB95">"JB has simplified to get the list <br/>of legal firms</h4>
		  <!--Firms list-->
		  <br/><br/><br/>
		    <?php 
			 include 'connect.php';
			 $sqlget="SELECT * From firms";
             ...
             while($row=mysqli_fetch_assoc($sqldata)){
                 ...
                 $d=$row['interest_area'];
                     ...
                     echo "<div class='panel panel-default'>
					           <div class='panel-heading' style='font-family:monospace;font-size:20px;color:#05386B'>$a</div>
		                          <div class='panel-body' style='font-family:serif;font-size:20px;color:#5CDB95'>$d 
								  <br/><br/><form method='POST' action='details.php'>
