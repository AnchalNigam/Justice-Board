      ...
      <div class="col-lg-3"><br/><br/><br/><br/><br/><br/><br/><br/><br/>
	   ...
	   <div class="col-lg-7">
          ...
          if(isset($_POST['submit'])){
             ...
             $name=mysqli_query($con,"SELECT * FROM lawyer WHERE lawyer_name='$k'");
			 ...
			 $x=$res["education"];
			 $y=$res["specialization"];
			 $z=$res["practice_court"];
			 $h=$res["address"];
			 $i=$res["contact"];
			 echo "<h4 style='font-family:garamond;color:#FF9999'><strong>Name: </strong>$v<br/>
			 <strong>Experience: </strong>$w<br/>
			 <strong>Education: </strong>$x<br/>
			 <strong>Specialization: </strong>$y<br/>
			 <strong>Practice Court: </strong>$z</h4>";
}
...
?>
		  ...
		  <div id="2" class="tab-pane fade">
			 ...
			 echo "<h4 style='font-family:garamond;color:#FF9999'><strong>Address: </strong>$h<br/><strong>Contact No.</strong>:$i</h4>";
